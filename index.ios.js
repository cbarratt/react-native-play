...
const REQUEST_URL = 'http://home.barratt.me:4000/api/v1/weighins';
...
class Welcome extends Component {
  ...
  _submitForm = () => {
    ...
    fetch('http://api.postcodes.io/postcodes/' + postcode)
      ...
      .then((responseData) => {
        this.setState({
          serviceData: responseData.result,
          loaded: true,
        });
      })
      .done();
    ...
    return (
      <View style={styles.container}>
        <View style={styles.weightContainer}>
          ...
          <Text style={styles.postcodeData}>{this.state.serviceData.parish}</Text>
          <Text style={styles.postcodeData}>{this.state.serviceData.nuts}</Text>
          <Text style={styles.postcodeData}>{this.state.serviceData.nhs_ha}</Text>
        </View>
      </View>
    );
  }
